# Builder Stage
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.6-902.1661794353 as builder
...
# Release Stage
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.6-902.1661794353 as release
