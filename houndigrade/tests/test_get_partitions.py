...
class TestGetPartitions(TestCase):
    ...
    def test_find_partitions(self, mock_blkid, mock_click, mock_glob):
    ...
    @patch("cli.click")
    @patch("cli.sh.blkid", create=True)
    def test_find_no_partitions(self, mock_blkid, mock_click, mock_glob):
    ...
    @patch("cli.click")
    @patch("cli.sh.blkid", create=True)
    def test_no_idea(self, mock_blkid, mock_click, mock_glob):
